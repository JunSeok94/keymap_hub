...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(LCTL_T(KC_GESC), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS, LALT_T(KC_LPRN), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, LSFT_T(KC_RPRN), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO, LGUI_T(KC_COMM), LGUI_T(KC_DOT), KC_GCLEFT, KC_GCRGHT, RSFT_T(KC_ENT), LT(4,KC_HAEN), KC_MPLY, RGUI(KC_L), KC_CAPS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RGUI_T(KC_HANJ), RALT_T(KC_TAB), RCTL_T(KC_SPC), LT(3,KC_BSPC), KC_BTN1, KC_BTN2, KC_NO, KC_NO, KC_NO, KC_NO),
	...
	[3] = LAYOUT(RGB_VAI, KC_MPRV, KC_LBRC, KC_UP, KC_RBRC, KC_BTN2, KC_BTN2, KC_WH_U, KC_MS_U, KC_WH_L, KC_F13, KC_F14, RGB_VAD, LSFT_T(KC_MNXT), KC_LEFT, KC_DOWN, KC_RGHT, KC_BTN1, KC_BTN1, KC_MS_L, KC_MS_D, KC_MS_R, KC_F15, KC_F16, RGB_SPI, RGB_MOD, KC_HOME, KC_DEL, KC_END, KC_BTN3, KC_BTN3, KC_WH_D, KC_NO, KC_WH_R, KC_F17, KC_F18, RGB_SPD, RGB_RMOD, KC_WBAK, KC_WFWD, TO(1), TO(2), KC_TRNS, KC_TRNS, KC_BTN4, KC_BTN5, KC_NO, KC_NO, KC_NO, KC_NO, RGB_TOG, KC_WSCH, LCTL_T(KC_PSCR), KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO),
	[4] = LAYOUT(KC_GRV, KC_BSLS, KC_7, KC_8, KC_9, KC_0, KC_PSCR, KC_HOME, KC_UP, KC_PGUP, KC_NO, KC_NO, KC_SCLN, KC_QUOT, KC_4, KC_5, KC_6, KC_EQL, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_NO, KC_NO, KC_F2, KC_SLSH, KC_1, KC_2, KC_3, KC_MINS, KC_NO, KC_END, KC_DEL, KC_PGDN, KC_NO, KC_NO, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F9, LCTL_T(KC_F9), LSFT_T(KC_F10), KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO)
};
