...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[3] = LAYOUT(KC_F3, KC_F4, KC_GCLEFT, KC_UP, KC_GCRGHT, KC_HOME, KC_BTN2, KC_WH_U, KC_MS_U, KC_WH_L, KC_NO, KC_NO, KC_F5, LSFT_T(KC_F6), KC_LEFT, KC_DOWN, KC_RGHT, KC_END, KC_BTN1, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_NO, KC_F7, KC_COMM, KC_DOT, KC_LBRC, RSFT_T(KC_RBRC), KC_PGUP, KC_BTN3, KC_WH_D, KC_F1, KC_WH_R, KC_NO, KC_NO, KC_F8, KC_F10, KC_F11, KC_F12, LALT(KC_F4), KC_PGDN, TO(2), TO(1), KC_BTN4, KC_BTN5, KC_NO, KC_NO, KC_NO, KC_NO, KC_F13, KC_F14, LCTL_T(KC_F15), KC_TRNS, KC_BTN2, KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO),
